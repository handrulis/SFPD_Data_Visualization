...
//so charts automtically resize when page dimensions change
$(window).resize(function() {
	plotData(data);
});
//configuration for file parser
var config = {
...
//main function to run the methods that organize data and draw charts
...
//function fills the selection boxes needed for the predictUnitType
//function with the correct zipcodes
function fillSelectBox() {
	var zipcodeList = Array.from(zipcode.keys());
	var x = document.getElementById('zipcodeSelect');
	//add zipcodes to the list
...
//after user selects a zipcode and time for an incident from
//a list this function will predict the unit type needed to respond
...
//draws the scatter chart to plot incident response-time data
